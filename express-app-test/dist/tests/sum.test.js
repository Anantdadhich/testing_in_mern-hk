...
(0, globals_1.describe)("POST /sum", () => {
    (0, globals_1.it)("should return the sum of two numbers", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(zod_1.app).post("/sum").send({
            a: 1,
            b: 2
        });
    ...
    (0, globals_1.it)("should return the sum of two neg numbers", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(zod_1.app).post("/sum").send({
            a: -1,
            b: -2
        });
